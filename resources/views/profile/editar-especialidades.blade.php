...
@section('content')
  ...
  <div style="background-color: #FFFFFF; border: 1px solid #ECECEC;" class="col-sm-8 col-sm-offset-4 col-md-9 col-md-offset-3 col-lg-10 col-lg-offset-2 main">
    ...
    @if (session('servicos-atualizados'))
      <span style="display: none;" id="servicos-atualizados" class="help-block">
        <strong class="text-success">{{ session('servicos-atualizados') }}</strong>
      </span>
    @endif
